		...
		<div class="row small-spacing">
			<div class="col-sm-12">
				<div class="box-content">
					<form data-toggle="validator" class="row" action="{{ Route('admin.articleCreate') }}" method="POST" enctype="multipart/form-data"> @csrf
						{{-- headline --}}
						<div class="form-group col-sm-12">
							<label for="inputHeadline" class="control-label">Headline</label>
							<input type="text" name="headline" class="form-control" id="inputHeadline" required>
						</div>
						{{-- article_cat --}}
						<div class="form-group col-sm-12">
							...
							<select name="article_cat" id="inputArticleCat"class="form-control">
								...
								@foreach ($serviceData as $item)
									<option value="{{ $item->id }}">== {{ $item->headline }} ==</option>
								@endforeach
							</select>
							{{-- Status --}}
							<div class="col-sm-12">
						...
						<div class="form-group col-sm-12">
							...
							<textarea class="form-control" name="meta_tags"></textarea>
						</div>
						{{-- Meta Desc --}}
						<div class="form-group col-sm-12">
